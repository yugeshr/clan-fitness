...
export function Toaster() {
  ...
  return createPortal(
    <div
      // Bottom-center: clears BottomNav on mobile (same breakpoint-driven offset FeedbackFab
      // already uses) and FeedbackFab's own bottom-right position, without any z-index coordination
